<?php
include ("func.php");// файл bd.php должен быть в той же папке, что и все остальные, если это не так, то просто измените путь
 ...
 if (($num_rows) == 1) {
  ...
  exit ("Извините, введённый вами login или пароль неверный.");
    ...
    //если пароли совпадают, то запускаем пользователю сессию! Можете его поздравить, он вошел!
		...
		echo "Вы успешно вошли на сайт как ".$_SESSION['login']." <a href='http://1gbfiz.ru'>Главная страница</a>";
		}
	else {
